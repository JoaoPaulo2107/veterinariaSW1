...
-- Usuário admin
INSERT INTO usuario (Telefone, CPF, Email, Senha, Nome)
VALUES (
  '11999999999',
  '00000000000',
  'admin@vet.com',
  '$2y$10$Q0VoBwD4xlLA4KyO9MRYduhPl0cuO/qY6qrSIzbI60b09ss36Z8kK',
  'Administrador'
);
...
-- CONSULTA
-- ======================================================
INSERT INTO Consulta (ID_consulta, Data_consulta, Procedimento, Horario, Observacao, ID_Animal, ID_veterinario)
VALUES (2, '2024-01-16', 'Check-up', '14:00', 'Consulta de rotina', 2, 2);
